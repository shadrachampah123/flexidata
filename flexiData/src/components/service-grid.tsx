// Same prefetch rule as bottom-nav/side-nav: default viewport prefetch only
// (loading shells), so every navigation revalidates live wallet data instead
// of serving a fully-prefetched — possibly stale — RSC payload.
